...
Инструменты Linux и открываемая 3D-подоснова: [T01](deliverables/T01/v001/00_tools.md).
...
Кораблестроительная исследовательская база от 10.09.2026: [научные методы, тенденции 2026, интерьер и компоновка](knowledge/README.md). Статус SOURCES_REVIEWED; параметры яхты и оборудование этим исследованием не утверждены.
...
## Полученные чертежи и фотографии

[Структурированный каталог исходников](documentation/README.md) — модели и теоретические линии, планировка, парусный план, фотографии, реестр дублей и контрольные суммы. [Постоянный порядок сохранения и синхронизации](office/document-control.md).
